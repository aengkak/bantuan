      ...
      <div class="topbar-main">
         <div class="container">
            ...
            <div class="logo">
               ...
               <!--</a>-->
               <!-- Image Logo -->
               <a style="cursor: pointer;" onclick="pindah('pilih');" class="logo">
               <img src="<?php echo base_url();?>assets/images/logo.png" alt="" height="30" id="logok">
               </a>
            </div>
            <!-- End Logo container-->
            <div class="menu-extras">
               <ul class="nav navbar-nav navbar-right pull-right">
                  ...
                  <li class="dropdown navbar-c-items">
                     ...
                     <img id="gambar" src="<?php echo base_url();?>assets/images/user.png" alt="user-img" class="img-circle"> 
                     </a>
         ...
         <div class="container">
            <div id="navigation">
               ...
               <ul class="navigation-menu">
                  ...
                  <li class="has-submenu">
                     <a style="cursor: pointer;" onclick="pindah('pilih');"><i class="mdi mdi-view-dashboard"></i>Beranda</a>
                  </li>
                  ...
                  <li class="has-submenu">
                     <a style="cursor: pointer;" onclick="pindah('<?php echo strtolower($key->akses);?>');"><i class="mdi mdi-google-pages"></i><?php echo ucfirst($key->akses);?></a>
                  </li>
                  <?php } } } ?>
                  <!--<li class="has-submenu">
